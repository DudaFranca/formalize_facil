...
<head>
<meta charset="utf-8">
	<title>Formalização detalhada</title>
</head>
<body>
	<h1>Formalização </h1>
	<h2>O Microempreendedor Individual (MEI) tem direito a aposentadoria, salário-maternidade, auxílio-doença e outros benefícios. Mas para isso, é preciso estar em dia com outros deveres do MEI.
...
Vantagens:
    ...
    Salário-maternidade;
    Pensão por morte.</h2>
    <h2>Procure a prefeitura antes de começar

A concessão do Alvará definitivo depende de normas municipais. Alguns Municípios mantém o serviço de consulta prévia para o empreendedor verificar se o local escolhido para estabelecer a sua empresa está de acordo com essas normas.

    Após a inscrição, guarde o seu Certificado da Condição de Microempreendedor Individual (CCMEI) e mantenha-o em local visível em sua empresa.
    Após o prazo de 180 dias, não havendo manifestação da Prefeitura Municipal quanto à correção do endereço onde está estabelecido o MEI e quanto à possibilidade de exercer a atividade empresarial no local desejado, o alvará provisório se converterá automaticamente em alvará de funcionamento definitivo.

Guarde as notas fiscais

O Microempreendedor Individual está dispensado de contabilidade e, portanto, não precisa escriturar nenhum livro. No entanto, ele deve guardar as notas de compras de mercadorias, os documentos do empregado contratado e o canhoto das notas fiscais que emitir.
...
Significa, também, que não há intenção de fragilizar as relações de trabalho, não devendo o instituto ser utilizado por empresas para a transformação em Microempreendedor Individual de pessoas físicas que lhes prestam serviços.</h2>
<h2>Atividades Permitidas<li><ol> Atividades Permitidas
